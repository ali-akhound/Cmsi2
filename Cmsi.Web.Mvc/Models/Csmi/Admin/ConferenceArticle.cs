...
{
    public class ConferenceArticleViewModel
    {
        [ShowInGridview]
        [Display(Name = "ID")]
    ...
    public class ArticleSelective
    {
        public string ID { get; set; }
        public string Name { get; set; }
    }
    public class Select2ConferenceArticleViewModel
    {
        public string Name { get; set; }
    ...
    public class ConferenceArticleDetailViewModel
    {
        [ShowInGridview]
        [Display(Name = "ID")]
